            ...
            <div className="flex items-center gap-5 flex-1 min-w-0">
              ...
              <div className="cursor-pointer flex-1 min-w-0" onClick={() => { setTransactionToEdit(t); setIsEditTransactionModalOpen(true);}}>
                <div className="flex items-center gap-2 mb-1">
                  ...
                  {t.source === 'fintoc' && (
                    <span className="px-2 py-0.5 bg-emerald-50 text-emerald-600 text-[8px] font-black uppercase tracking-widest rounded-lg border border-emerald-100 shrink-0">Auto</span>
                  )}
                  {t.is_split && (
