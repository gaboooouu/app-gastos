  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
      <div className="w-full max-w-md bg-[#F0F2F5] rounded-3xl p-8 relative">
        ...
        <h2 className="text-2xl font-black text-slate-800 mb-6 tracking-tight">Editar Cuenta</h2>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-2">
            <label className="text-sm font-bold text-slate-500 uppercase tracking-wide">Saldo Actual</label>
            <input 
              type="number" 
              value={balance}
